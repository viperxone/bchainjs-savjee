//PART 4
//small problem with previous versions
//anyone can make any transactions that he wants
//effectively, one can make transactions that is not theirs
//to solve, make it mandatory for transactions to be signed
//with public and private keys. in this way one can spend
//coins in a wallet that one has the private key to

//first we cut all the classes in here and paste it in a blockchain.js
//and then we export it. in the main.js, we will import blockchain.js
//and transactions.js. 
//from now one refer to blockchain.js, transaction.js and main.js
